...
message.innerHTML="Long URL: "+b.length+" (cs). Short URL: "+c.length+" (cs). You saved: "+(b.length-c.length)+" (cs)";tic.copyToClipboard()}};xmlhttp.open("GET","php/insertURL.php?k="+a+"&v="+b,!0);xmlhttp.send()},getRealURL:function(a){console.log("Get real url for: "+a);xmlhttp=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");xmlhttp.onreadystatechange=function(){if(4==xmlhttp.readyState&&200==xmlhttp.status){response=xmlhttp.responseText;console.log("Response: "+
